 ...
 import {
   GET_QUESTIONS,
   GET_QUESTIONS_SUCCEED,
   GET_QUESTIONS_FAILED,
   POST_QUESTIONS,
   POST_QUESTIONS_FAILED,
   POST_QUESTIONS_SUCCEED,
   GET_ROLES,
   GET_ROLES_SUCCEED,
   GET_ROLES_FAILED,
   GET_MAPPINGS_SUCCEED,
   GET_MAPPINGS_FAILED,
   GET_MAPPINGS,
   DELETE_QUESTIONS_FAILED,
   DELETE_QUESTIONS_SUCCEED,
   DELETE_QUESTIONS,
   EDIT_QUESTIONS,
 ...
 const getMappingsData = function* (action) {
   try {
     ...
     if (response.statusText === "OK") {
       yield put({
         type: GET_MAPPINGS_SUCCEED,
         data
       });
     } else
       yield put({
         type: GET_MAPPINGS_FAILED,
         data
       });
   } catch (e) {
     yield put({
 ...
 const postQuestionsData = function* (action) {
   try {
     ...
     if (response.statusText === "OK") {
       yield put({
         type: POST_QUESTIONS_SUCCEED,
         data
       });
     } else
       yield put({
         type: POST_QUESTIONS_FAILED,
         data
       });
   } catch (e) {
     yield put({
 ...
 const deleteQuestionsData = function* (action) {
   try {
     ...
     if (response.statusText === "Not Acceptable") {
       yield put({
         type: DELETE_QUESTIONS_SUCCEED,
         data
       });
     } else
       yield put({
         type: DELETE_QUESTIONS_FAILED,
         data
       });
   } catch (e) {
     yield put({
 ...
 const editQuestionsData = function* (action) {
   ...
   try {
     ...
     if (response.statusText === "OK") {
       yield put({
         type: EDIT_QUESTIONS_SUCCEED,
         data
       });
     } else
       yield put({
         type: EDIT_QUESTIONS_FAILED,
         data
       });
   } catch (e) {
     yield put({
